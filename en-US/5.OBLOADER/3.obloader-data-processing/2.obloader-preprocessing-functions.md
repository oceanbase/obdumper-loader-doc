...
* For preprocessing functions related to date and time such as `[SYSTIMESTAMP[](https://help.aliyun.com/document_detail/212816.html)](https://help.aliyun.com/document_detail/212816.html)`, `TMSFMT()`, and `TO_TIMESTAMP()`, the value is accurate only to milliseconds. In addition, the server clock must be the same as that of the database.
