...
2. Decompress the package and enter the /bin directory. 
   ...
   <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/obloaderobdumper/410/bin.png" width = "560" height = "135" alt="run obloader" />
...
3. Execute the following statement to run the tool to view the help information of the command-line options:
   - Run OBLOADER
     ...
     <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/obloaderobdumper/410/obloader.png" width = "560" height = "346" alt="run obloader" />
   ...
   - Run OBDUMPER
     ...
     <img src="https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/obloaderobdumper/410/obdumper.png" width = "560" height = "331" alt="run obdumper" />
