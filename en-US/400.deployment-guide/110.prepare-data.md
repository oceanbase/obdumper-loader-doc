...
```sql
-- Examples in Oracle compatible mode
...
-- Examples in MySQL compatible mode
INSERT INTO `employees` (`Name`, `Age`, `SELECT`, `City`) VALUES ('John Smith', 32, 'Engineer', 'New York');
...
In an Oracle database or Oracle compatible mode of OceanBase Database, datetime types are complex and likely to cause errors in operations, such as precision, format, and time zone errors.
