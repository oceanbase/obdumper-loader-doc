...
> **Notice**
> - A control file is named in the format of **<table name>.ctrl**.<br>
> - The **order of columns** defined in the control file must be consistent with that defined in the table. Column names defined in the control file must be in the **same letter case** as those in the table.<br>
