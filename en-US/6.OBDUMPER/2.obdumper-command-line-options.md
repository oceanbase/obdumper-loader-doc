...
| --endpoint | No | The endpoint of the region where the Object Storage Service (OSS) bucket resides. In OBLOADER V4.1.0 or earlier, this option is `--oss-point`.  |     4.1.0     |          |
...
* --endpoint ' ***oss_endpoint_string*** '
   ...
   <h4>Note</h4>
   <p>In OBLOADER V4.1.0 or earlier, this option is `--oss-point`.</p>
   </main> 
