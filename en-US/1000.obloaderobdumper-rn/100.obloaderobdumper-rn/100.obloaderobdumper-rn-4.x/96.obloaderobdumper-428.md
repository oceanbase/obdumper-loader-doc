...
<!--* The following figure shows the feature differences in schema export in the MySQL compatible and Oracle compatible modes.

   ![Known issues](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/-->
