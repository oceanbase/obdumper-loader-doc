...
OBLOADER & OBDUMPER V4.2.5 released in August 2023 allows you to import data in bypass mode and import files containing duplicate data in Oracle compatible mode of OceanBase Database, and provides preprocessing functions.
...
* OBLOADER and OBDUMPER:
  ...
  * The `ob.sql.mode` session variable is added. It allows you to modify the `sql_mode` variable of a session in MySQL compatible mode of OceanBase Database during import. For more information, see [Connection settings](../../../800.obloaderobdumper-session-variables.md).
