...
* In the MySQL compatible mode of OceanBase Database, after you enable case sensitivity for object names such as table names and view names, objects are imported or exported in a case-insensitive manner.
