...
Derive V4.3.4.1 released in September is designed to fix critical issues reported by users when using Derive V4.3.4 and earlier versions.
...
* Fixed the issue where the `--default-date` parameter in Derive V4.x was not backward compatible with the deprecated parameter in the MySQL compatible mode of OceanBase Database.
