...
* Fixed the issue where the export fails if the name of a sequence is in lowercase when OBDUMPER is used to export data from OceanBase Database in the Oracle compatible mode.
