...
* Schema export performance optimization is supported for Oracle tenants of OceanBase Database only in the following scenarios:

  * The `--no-sys` option is used in the export for an Oracle tenant of OceanBase Database of a version earlier than V4.0.0.

  * The `--compact-schema` option is used in the export for an Oracle tenant of OceanBase Database V4.0.0 or later.
