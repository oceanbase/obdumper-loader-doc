...
* Fixed an issue that when you use OBDUMPER to export data from OceanBase Database in the MySQL compatible mode, an error is returned if zero values of DATETIME or TIME fields are exported.

* Fixed an issue that OBDUMPER cannot export public synonyms from OceanBase Database in the Oracle compatible mode.
