...
* OBLOADER:
  ...
  * The `--include-column-names` option is added, which allows you to specify the column names and column sequence to import data. For more information, see [Command-line options of OBLOADER](../../../500.OBLOADER/200.obloader-command-line-options.md).
...
* OBLOADER and OBDUMPER:
  ...
  * The configurable session variables are streamlined. For more information, see [Session management](../../../800.obloaderobdumper-session-variables.md).
