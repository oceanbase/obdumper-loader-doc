...
* OBLOADER:
  ...
  * Direct load parameters are added in the connection configuration file `session.config.json` in the `{ob-loader-dumper}/conf` directory. For more information, see [Direct load](../../../500.OBLOADER/502.obloader-bypass-import.md).
