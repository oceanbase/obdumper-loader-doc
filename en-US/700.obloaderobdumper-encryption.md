...
Configure SSL parameters in the `session.config.json` file. For more information about the file, see [Connection settings](800.obloaderobdumper-session-variables.md).
