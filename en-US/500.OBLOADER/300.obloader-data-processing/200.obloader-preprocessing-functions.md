...
* `REPLACE()` is used differently in the Oracle compatible and MySQL compatible modes. It has the syntax that is similar to an Oracle function but is implemented like a MySQL function.
