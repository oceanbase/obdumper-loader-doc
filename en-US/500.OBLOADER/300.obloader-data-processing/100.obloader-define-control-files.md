...
You can define rules in a control file by which OBLOADER can [preprocess](../300.obloader-data-processing/200.obloader-preprocessing-functions.md) the data before importing it.
...
* In OBLOADER V3.x, the field mapping feature of map files is integrated into control files. Map files are no longer supported. Example:
   ...
   <main id="notice" type='explain'>
      ...
      <li>Generated columns are columns that do not exist in data files. OBLOADER can use the following functions to preprocess generated columns: <code>CONSTANT</code>, <code>SEQUENCE</code>, and <code>DB_SEQUENCE</code>. Example: <code>C4 "SEQUENCE(100, 1)"</code>. For more information, see <a href="../300.obloader-data-processing/200.obloader-preprocessing-functions.md">Preprocessing functions</a>. </li>
      </ul>
   </main>
...
2. Define a control file. Configure a preprocessing function for each imported column in the control file.[](../300.obloader-data-processing/200.obloader-preprocessing-functions.md)
   ...
   **Sample code**:
   ...
   ```
    ...
    <main id="notice" type='notice'>
       <h4>Notice</h4>
       <ul>
       <li>The file name extension of a control file is  <table_name>.ctrl. </li>
