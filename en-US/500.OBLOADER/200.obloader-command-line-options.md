...
| --line-separator          | No    | The line separator. <br>When you import CSV, CUT, POS, or SQL files, you can specify the newline character in the data file. The default value of this option depends on the system platform and includes only three possible values: ***\\r***, ***\\n***, and ***\\r\\n***.         |          |          |
