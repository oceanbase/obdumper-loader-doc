...
| --null-string             | No    | The string to replace NULL. Default value: \\N. <main id="notice" type='notice'><h4>Notice</h4><p>`,,` and `,"",` are both parsed as empty strings. Only when the content is \\N is it parsed as the NULL value. </p></main>                 |          |          |
| --empty-string            | No    | The string to replace empty strings (' '). Default value: \\E. <main id="notice" type='notice'><h4>Notice</h4><p>`,,` and `,"",` are both parsed as empty strings. Only when the content is \\N is it parsed as the NULL value. </p></main>                  |          |         |
