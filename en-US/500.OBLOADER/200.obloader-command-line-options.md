...
For more information about the OBKV feature, see the **Import HBase data into OBKV** section in [Get Started](100.obloader-quick-start.md).

* --hbase-cf

  Specifies the column family to write to HBase.

* --hbase-rowkey

  Specifies the name of the rowkey column to write to HBase.

* --hbase-rowkey-reverse

  Specifies whether to reverse the rowkey column when writing to HBase.
