...
* -f '***file_path***', --file-path= '***file_path***'
  ...
  |--------|------|------|------|------|
  | endpoint  |Yes |<ul><li>The endpoint of the region where the host is located. </li><li>To access Amazon S3, Tencent Cloud Object Storage, and Huawei Cloud Object Storage Service, specify the endpoint by domain name. </li></ul>Example: `oss://ssmp-xxxx-xxxx/test?endpoint=oss-cn-shenzhen-internal.aliyuncs.com`.|[OSS](https://help.aliyun.com/zh/oss/user-guide/regions-and-endpoints)/[S3](https://docs.aws.amazon.com/general/latest/gr/s3.html)/[COS](https://www.tencentcloud.com/document/product/436/6224)/[OBS](https://support.huaweicloud.com/productdesc-obs/obs_03_0152.html)|<ul><li>OSS: V4.2.0 </li><li>S3: V4.2.5 </li><li>COS and OBS: V4.3.0 </li></ul>|
