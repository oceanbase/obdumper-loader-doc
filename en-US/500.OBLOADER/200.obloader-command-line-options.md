...
| --sql<br>Imports data files in the SQL format.  | <ul><li>--line-separator '***line_separator_string***'<br>The line separator. </li><li> --ignore-unhex<br>Ignores hexadecimal strings in decoding. This option applies only to binary data types. </li><li> --character-set '***character_set_string***'<br>The character set for a database connection. </li><li>--null-string '***null_replacer_string***'<br>Replaces the specified character with `NULL`. </li><li>--file-suffix '***suffix_name***'<br>Specify Data File Format for Import.  </li><li>--file-encoding '***encode_name***'<br>The character set of the files to read, which is not the database character set. </li></ul> | This option applies to scenarios where only data but no schema is imported. Only one SQL syntax with high performance is supported.  |
| --mix<br>Imports MIX files.  | <ul><li> --character-set '***character_set_string***'<br>The character set for a database connection. </li><li>--file-suffix '***suffix_name***'<br>Specify Data File Format for Import. </li><li>--file-encoding '***encode_name***'<br>The character set of the files to read, which is not the database character set. </li><li> --compat-mode<br>Imports MySQL table schema definitions in compatible mode. </li></ul> | This option can be used to import SQL files in any format. It has higher compatibility but poorer performance than the `--sql` option. <br>At present, the whole text is read to the memory for parsing. Therefore, this option is inapplicable if you want to process files of a large data mount.  |
| --par<br>Imports data files in the Parquet format.  | <ul><li>--character-set '***character_set_string***'<br>The character set for a database connection. </li><li>  --ignore-unhex<br>Ignores hexadecimal strings in decoding. This option applies only to binary data types. </li><li>--file-suffix '***suffix_name***'<br>Specify Data File Format for Import. </li><li>--file-encoding '***encode_name***'<br>The character set of the files to read, which is not the database character set. </li></ul> | This option can be used to migrate data from Hive, Spark, or another data source that supports exporting data in the standard Parquet format.  |
| --orc<br>Imports data files in the ORC format.  | <ul><li>--character-set '***character_set_string***'<br>The character set for a database connection.  </li><li> --ignore-unhex<br>Ignores hexadecimal strings in decoding. This option applies only to binary data types. </li><li>--file-suffix '***suffix_name***'<br>Specify Data File Format for Import. </li><li>--file-encoding '***encode_name***'<br>The character set of the files to read, which is not the database character set.  </li></ul> | This option can be used to migrate data from Hive, Spark, or another data source that supports exporting data of the standard ORC format.  |
| --ddl<br>Imports DDL files.  | <ul><li>  --character-set '***character_set_string***'<br>The character set for a database connection. </li><li>--ignore-unhex<br>Ignores hexadecimal strings in decoding. This option applies only to binary data types. </li><li>--file-suffix '***suffix_name***'<br>Specify Data File Format for Import.  </li><li>--file-encoding '***encode_name***'<br>The character set of the files to read, which is not the database character set.  </li></ul> | This option applies to logical backup.  |
| --avro <br>Imports data files in the Avro format.  | --file-suffix '***suffix_name***'<br>Specify Data File Format for Import.  | Generally, this option applies to the big data field for offline migration of analytical processing (AP) business data and other scenarios.  |

<main id="notice" type='explain'>
   <h4>Note</h4>
   <p>For more information about command-line options, see the option list in this topic.  </p>
</main>
