...
* --max-discards ***int_num***
  ...
  <main id="notice" type='notice'>
      <h4>Note</h4>
      <ul>
      <li>This option takes effect only when a table has a primary key or unique key and contains duplicate data. It also applies only to errors that occur during the data import to the database, not to other types of errors (such as those that occur when data is read from the database file). </li>
...
* --max-errors ***int_num***
  ...
  <main id="notice" type='notice'>
      <h4>Notice</h4>
      <ul>
      <li>This option applies only to errors generated during data writing and does not apply to other types of errors (such as errors generated during data reading from a database file).</li>
      <li>This option does not apply to direct load.</li>
      </ul>
    </main>
...
| --max-discards            | No    | The maximum number of duplicate records allowed for a single table during import. Default value: -1. <main id="notice" type='notice'><h4>Notice</h4><ul><li>This option takes effect only when a table contains a primary key or unique key and duplicate data exists. It applies only to errors that occur during data writing to the database, not to other types of errors (such as errors that occur when reading data from the database file). </li><li>This option is not applicable to direct load. </li></ul></main>                   |          |          |
| --max-errors              | No    | The maximum number of errors allowed for a single table during import. Default value: 1000.  <main id="notice" type='notice'><h4>Notice</h4><ul><li>This option applies only to errors that occur during data writing to the database, not to other types of errors (such as errors that occur when reading data from the database file). </li><li>This option is not applicable to direct load. </li></ul></main>                   |          |          |
