...
* --table-group
  Imports ***table group*** definitions.
<br><br>
* --all
...
* --exclude-column-names **'** ***column_name [, column_name...]*** **'** 
  ...
  > **Notice**
  > 
  > The case of columns defined in the data file must be consistent with that defined in the table.<br>
  > In the imported data file, the data corresponding to the excluded column does not exist and the order of the imported columns must be consistent with the order of the columns in the table.
