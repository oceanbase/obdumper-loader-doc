...
* --exclude-column-names **'** ***column_name [, column_name...]*** **'** 
  ...
  > **Notice**  
  > In the imported data file, his option will only take effect if the order of fields in the data file is consistent with the order of fields in the table structure after excluding the specified column. There is no data in the excluded specified column.
