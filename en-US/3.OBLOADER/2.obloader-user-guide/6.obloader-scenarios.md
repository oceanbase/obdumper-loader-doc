...
Import structures and data in limited mode 
---------------------------------------------------------------

**Scenario description** : Import all supported structures and data under `/output` to the USERA schema in limited mode. 
