...
> - For more information about preprocessing functions, see [Preprocessing functions](../../../2.OBLOADER/2.obloader-user-guide/5.obloader-data-processing/2.obloader-preprocessing-functions.md).
