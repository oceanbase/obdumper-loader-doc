...
| --line-separator          | No     | Specifies the line separator. <br> You can specify a custom line separator when you export files in the CSV, CUT, POS, or SQL format. The default value varies with the system platform and can be one of the following values: ***\\r***, ***\\n***, or ***\\r\\n***.                                   |          |          |
