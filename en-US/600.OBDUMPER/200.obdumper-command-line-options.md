...
* --weak-read
   ...
   Exports data from the follower replica. For more information about Weak-consistency read, see [Weak-consistency read](https://en.oceanbase.com/docs/common-oceanbase-database-10000000001717206).
