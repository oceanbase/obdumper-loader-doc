...
| --orc                     | No    | Specifies to export data in ORC files. <br>ORC files store data in columnar format. The naming convention is ***table name.orc***. For more information about the ORC format, see [Apache ORC](https://orc.apache.org/specification/ORCv1/). |       V4.0.0   |          |
