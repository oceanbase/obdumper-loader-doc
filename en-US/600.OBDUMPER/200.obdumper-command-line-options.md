...
* --block-size ***int_num***
  ...
  <main id="notice" type='notice'>
  <h4>Note</h4>
  <p>When you use <code>--block-size</code>, you must specify <code>-f</code> as a <strong>directory</strong>. If you specify <code>-f</code> as a filename, OBDUMPER will only export a single file with the size specified by <code>--block-size</code>.</p>
  </main>
