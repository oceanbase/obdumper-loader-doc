...
* -f '***file_path***', --file-path= '***file_path***'
  ...
  |--------|-------|-------|-------|-------|
  | endpoint  |Yes |<ul><li>The endpoint of the host where the OSS bucket is located.</li><li>You can use the endpoint to access S3, COS, and OBS services via domain name.</li></ul> Example: `oss://ssmp-xxxx-xxxx/test?endpoint=oss-cn-shenzhen-internal.aliyuncs.com`|[OSS](https://help.aliyun.com/zh/oss/user-guide/regions-and-endpoints)/[S3](https://docs.aws.amazon.com/general/latest/gr/s3.html)/[COS](https://www.tencentcloud.com/document/product/436/6224)/[OBS](https://support.huaweicloud.com/productdesc-obs/obs_03_0152.html)|<ul><li>OSS: V4.2.0</li><li>S3: V4.2.5</li><li>COS/OBS: V4.3.0</li></ul>|
  | region |Yes |The endpoint of the host, which indicates the physical location where the bucket is located. |OSS/S3/COS/OBS|<ul><li>OSS/S3: V4.2.0</li><li>COS/OBS: V4.3.0</li></ul>|
