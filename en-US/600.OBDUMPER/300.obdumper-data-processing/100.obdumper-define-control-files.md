...
(
  ...
  c12 "lpad(c12,5,'x')",                                                                          -- prepend 'x' to the left of the values in column c12 to make them 5 characters long
  c13 "rpad(c13,5,'x')",                                                                 -- Right-pad the c13 column with 5 'x' characters
  ...
  c20 "lpadb(c20,5,'x')",                                                                      -- c20 column value left pad 5 bytes (single) with 'x'
  c21 "rpadb(c21,5,'x')",                                                                 -- Append 5 bytes (single character 'x') to the right side of the values in the c21 column.
  ...
  c27 "mask("c27",'A','a','b')",                                                                 -- c27 column convert uppercase letters to A, lowercase letters to a, and numbers to b
  c28 "mask_first_n(c28,'A','a','b',5)",                                                        -- in the first 5 characters of column c28, uppercase letters are converted to A, lowercase letters to a, and numbers to b.
  c29 "mask_last_n(c29,'A','a','b',5)",                                                         -- Convert the last 5 characters of the c29 column: uppercase letters to 'A', lowercase letters to 'a', and numbers to 'b'
  c30 "mask_show_first_n(c30,'A','a','b',5)",                                                   -- Convert all capital letters (except the first 5 characters) in the c30 column to A, all small letters to a, and numbers to b
  c31 "mask_show_last_n(c31,'A','a','b',5)"                                                       -- convert all uppercase letters to 'A' and all lowercase letters to 'a', and all numbers to 'b' in c31, except for the last five characters
);
```
