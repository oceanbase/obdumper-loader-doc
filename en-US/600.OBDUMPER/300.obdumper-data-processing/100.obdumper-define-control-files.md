...
|---|---|
|machine-translation||
|slug|obdumper-define-control-files|

# Define a control file

OBDUMPER can preprocess the exported data by using a predefined control file. For information about control file activation rules, column selection, fixed-length POS files, common use cases, and troubleshooting, see [Control file guide](../../650.control-file-guide.md).
...
* Preprocessing function: Configure a [preprocessing function](../300.obdumper-data-processing/200.obdumper-preprocessing-functions.md) in the control file for a specified column to preprocess the exported data.
  ...
  <main id="notice" type='notice'>
    ...
    <p>When <code>--ctl-path</code> points to a directory, OBDUMPER recursively searches the directory and its subdirectories for files with the <code>.ctrl</code> extension.</p>
  </main>
