...
lang=java
(
  column name (optional) byte offset "preprocessing function",
  column name (optional) byte offset "preprocessing function",
  column name (optional) byte offset "preprocessing function"
);
```
...
(
  ...
  c12 "lpad(c12,5,'x')",                                                                          -- Append 5 bytes of the character 'x' to the left of the values in the c12 column.
  c13 "rpad(c13,5,'x')",                                                                          -- Append 5 bytes of the character 'x' to the right of the values in the c13 column.
  ...
  c20 "lpadb(c20,5,'x')",                                                                         -- Append 5 bytes of the character 'x' to the left of the values in the c20 column.
  c21 "rpadb(c21,5,'x')",                                                                         -- Append 5 bytes of the character 'x' to the right of the values in the c21 column.
