...
| --mem   |   4G  |  This parameter is supported by OBDUMPER V4.3.2 and later versions, used to specify the VM memory size configuration. Supported units include K, M, G, or T. The parameter settings are described in the VM parameter-based performance tuning section below. |
