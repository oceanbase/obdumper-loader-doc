...
A: The name of the control file must be identical to the table name. By default, table names are in lowercase in the MySQL compatible mode and in uppercase in the Oracle compatible mode.
<br><br><br>
