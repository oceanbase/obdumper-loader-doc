...
| --all                     | 否    | 导出所有已支持的数据库对象结构和表数据。                               |          |          |
| --table-group             | 否    | 导出 ***表组*** 结构。                                    | 3.1.0    |          |
| --table                   | 否    | 导出 ***表*** 结构或者 ***表*** 数据。                        |          |          |
| --view                    | 否    | 导出 ***视图*** 结构。                                    |          |          |
| --function                | 否    | 导出 ***函数*** 结构。                                    |          |          |
| --procedure               | 否    | 导出 ***存储过程*** 结构。                                  |          |          |
| --trigger                 | 否    | 导出 ***触发器*** 结构。                                   |          |          |
| --sequence                | 否    | 导出 ***序列*** 结构。                                    |          |          |
| --synonym                 | 否    | 导出 ***同义词*** 结构。（暂不支持 MySQL 租户）                    |          |          |
| --type                    | 否    | 导出 ***类型*** 结构。                                              |          |          |
| --type-body               | 否    | 导出 ***类型体*** 结构。                                   |          |          |
| --package                 | 否    | 导出 ***程序包*** 结构。                                   |          |          |
| --package-body            | 否    | 导出 ***程序包体*** 结构。                                  |          |          |
