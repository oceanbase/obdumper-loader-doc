...
<p>如果您正在使用 obloader/obdumper V4.3.0-SNAPSHOT 之前的版本，请编辑 <code>bin/obloader</code> 文件，将 GC 参数从 <code>-XX:+UseG1GC</code> 修改为 <code>-XX:+UseConcMarkSweepGC</code>。</p>
<p>如果您正在使用 obloader/obdumper V4.3.0-SNAPSHOT 及之后的版本，请编辑 <code>bin/obloader</code> 文件，修改 <code>GC_OPTS</code> 参数。</p>
</main>
