...
| OceanBase 模式|支持的版本号|
|-------------------------|---------------------------|
| Oracle 模式 | V2.0.x、V2.1.x、V2.2.20、V2.2.30、V2.2.50、V2.2.70、V2.2.71、V2.2.72、V2.2.76、V2.2.77、V3.1.x、V3.2.x、V4.0.0、V4.1.0、V4.2.0、V4.2.1                   |
| MySQL 模式  | V1.4.70、V1.4.72、V1.4.75、V1.4.78、V1.4.79、V2.2.30、V2.2.50、V2.2.70、V2.2.71、V2.2.72、V2.2.76、V2.2.77、V3.1.x、V3.2.x、V4.0.0、V4.1.0、V4.2.0、V4.2.1 |
...
* OceanBase Oracle 结构导出的性能优化仅适用于以下场景：
  ...
  * OceanBase Oracle V4.0.0 之前的版本， 使用`--no-sys` 进行限制导出。

  * OceanBase Oracle V4.0.0 及之后的版本，使用新增选项`--compact-schema` 进行导出。
...
* 修复使用 OBDUMPER 导出 OceanBase Oracle V4.0.0 之前的版本数据时，分区表分页耗时太长的缺陷。
