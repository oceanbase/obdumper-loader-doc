...
本次 5 月发版的导数工具 V4.2.1 主要适配 OceanBase V4.1.0、支持从 Hadoop 导入数据库对象定义和表数据，以及对数据库连接池的资源管理进行了优化。
...
| OceanBase 模式|支持的版本号|
|-------------------------|--------------------------------------------------------------------------------------------------------|
| Oracle 模式 | V2.0.x、V2.1.x、V2.2.20、V2.2.30、V2.2.50、V2.2.70、V2.2.71、V2.2.72、V2.2.76、V2.2.77、V3.1.x、V3.2.x、V4.0.0、V4.1.0                   |
| MySQL 模式  | V1.4.70、V1.4.72、V1.4.75、V1.4.78、V1.4.79、V2.2.30、V2.2.50、V2.2.70、V2.2.71、V2.2.72、V2.2.76、V2.2.77、V3.1.x、V3.2.x、V4.0.0、V4.1.0 |
