...
| **OceanBase 模式**                 | **支持的版本号**                                                                                              |
|-------------------------|--------------------------------------------------------------------------------------------------------|
| Oracle 模式 | V2.0.x、V2.1.x、V2.2.20、V2.2.30、V2.2.50、V2.2.70、V2.2.71、V2.2.72、V2.2.76、V2.2.77、V3.1.x、V3.2.x |
| MySQL 模式  | V1.4.70、V1.4.72、V1.4.75、V1.4.78、V1.4.79、V2.2.30、V2.2.50、V2.2.70、V2.2.71、V2.2.72、V2.2.76、V2.2.77、V3.1.x、V3.2.x |
...
* OBDUMPER：
  ...
  * 限制模式下，OceanBase Oracle V2.2.50 之前的版本无法导出表结构的索引。

  * 限制模式下，OceanBase V2.2.70 之前的版本不支持导出表组结构。

  * 限制模式下，OceanBase V2.2.70 及之后的版本无法导出分区表唯一索引。

  * 非限制模式下，OceanBase V2.2.50 Oracle 之前的版本因无主建分区表中包含全局索引导致无法导出所有表结构。

  * 非限制模式下，OceanBase MySQL/Oracle V3.3.2 版本导出表结构定义的表组信息丢失。

  * 限制模式下，OceanBase V2.2.70 之前的版本一致性查询导出的数据不具备一致性（JDBC 问题）。

  * 非限制模式下，OceanBase V2.2.70 之前的版本一致性查询导出非分区且无主建表的数据不具备一致性（JDBC 问题）。
