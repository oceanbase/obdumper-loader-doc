...
3. 加密本地路径下的敏感文件。
   ...
   <main id="notice" type='explain'>
     <h4>说明</h4>
     <p>敏感文件的格式需要符合 <a href="https://docs.oracle.com/cd/E23095_01/Platform.93/ATGProgGuide/html/s0204propertiesfileformat01.html">Property File Format 规范</a>。或者在交互界面中编辑待加密的敏感信息。例如：</p>
   </main>
