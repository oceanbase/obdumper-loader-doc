...
```shell
[admin@localhost]> ./obloader -h xx.x.x.x -P 2883 -u test -p ****** --sys-password ****** -c cluster_a -t mysql -D USERA --ddl --all -f /output
```
...
```shell
[admin@localhost]> ./obloader -h xx.x.x.x -P 2883 -u test -p ****** --sys-password ****** -c cluster_a -t mysql -D USERA --csv --all -f /output
```
...
```shell
[admin@localhost]> ./obloader -h xx.x.x.x -P 2883 -u test -p ****** --sys-password ****** -c cluster_a -t mysql -D USERA --sql --all -f /output
```
...
```shell
./obloader -h xx.x.x.x -P 2883 -u test -p ****** --sys-password ****** -c cluster_a -t mysql
...
```shell
[admin@localhost]> ./obloader -h xx.x.x.x -P 2883 -u test -p ****** --sys-password ****** -c cluster_a -t mysql -D USERA --ddl --sql --public-cloud  --all -f /output
```