...
| -c(--cluster)             | 否    | 数据库的集群名。 OBDUMPER 4.2.8 及之后的版本已废弃该选项。                                          |          |          |
| -t(--tenant)              | 否    | 集群的租户名。 OBDUMPER 4.2.8 及之后的版本已废弃该选项。                                           |          |     是     |
