...
| --endpoint               | 否    | 指定 OSS Bucket 所在地域的 Endpoint。                      |          |          |
...
* --table ' ***table_name [,table_name...]*** ' | --table ' **\*** '
  ...
  > **说明**  
  > OBDUMPER 4.1.0 及之后的版本支持导出OceanBase Oracle 模式下的临时表定义。
...
* --file-name **'** ***file_name*** **'** 
  ...
  |             **用法说明**             |                        **使用示例**                        |                                   **文件路径**                                    |
  |----------------------------------|--------------------------------------------------------|-------------------------------------------------------------------------------|
  | 将自定义查询的结果导出到 `-f` 指定的目录          | --query-sql '查询语句' -f '/output' --file-name 'test.txt' | /output/data/Database/TABLE/test.txt                                                              |
  | 将自定义查询的结果导出到 `--file-name` 指定的文件 | --query-sql '查询语句' --file-name '/output/test.csv'      | /output/data/Database/TABLE/test.csv                                                              |
  | test 表数据导出到 `-f` 指定目录            | --table 'test' -f '/output/' --file-name 'test.txt'    | /output/data/Database/TABLE/test.txt                                          |
  | test 表数据导出到 `--file-name` 指定的文件  | --table 'test' --file-name '/output/test.csv'          | /output/data/Database/TABLE/test.csv                                                              |
  ...
  | 将多张表数据导出到 `--file-name` 指定的目录    | --table 'test1,test2' --file-name '/output/\*'         | /output/data/Database/TABLE/test1.csv,   /output/data/Database/TABLE/test2.csv                                        |
<br>
