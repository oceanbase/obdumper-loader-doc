...
|   --upload-behavoir               | 否    |     标识导出数据到云存储空间时的上传模式。                     |       4.2.0   |          |
...
* --fetch-size ' ***int_num*** '
  ...
  用于标识 Oracle 模式下每次从数据库游标中提取的行数。默认值：1000。具体配置请参考 [OceanBase FetchSize](https://www.oceanbase.com/docs/common-oceanbase-connector-j-cn-10000000001652365)。
