...
```
  ...
  <main id="notice" type='notice'>
    <h4>注意</h4>
    <ul>
    <li>控制文件的命名规范为 <strong>&lt;表名&gt;.ctrl</strong>。<br></li>
    <li>控制文件的内容要求<strong>列名的顺序</strong>与表中定义的列顺序保持一致，且<strong>列名大小写</strong>与表中的列名大小写保持一致。<br></li>
    <li>预处理函数定义请参考 <a href="../3.obdumper-data-processing/2.obdumper-preprocessing-functions.md">预处理函数</a>。</li>
    </ul>
  </main>
