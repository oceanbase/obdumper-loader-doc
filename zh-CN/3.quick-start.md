...
<main id="notice" type='notice'>
   <h4>注意</h4>
   <p>试用 OBDUMPER 导出功能时，用户无需准备任何数据，可以直接跳到步骤 4。</p>
</main> 

试用 OBLOADER 导入功能时，用户可以使用已有的数据文件，或者使用 TPC-H 工具临时生成数据文件。导入的文件的内容格式需要符合规范，请参考[《准备好您的数据了吗？》](https://open.oceanbase.com/blog/1100272)识别文件中的数据格式。
