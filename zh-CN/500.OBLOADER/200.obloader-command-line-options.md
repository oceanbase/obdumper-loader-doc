...
* --direct
  ...
  <main id="notice" type='explain'>
    ...
    <li> OBLOADER 旁路导入模式支持连接 OBServer 和 ODP。对应的版本要求：<ul><li>连接 OBServer 时：要求 OBServer 必须为 V4.2.0 及之后版本。</li><li>连接 ODP 时：要求 ODP 必须为 V4.1.3 及之后版本，且 OBServer 必须为 V4.2.1 及之后版本。</li></ul></li>
    </ul>
  </main>
