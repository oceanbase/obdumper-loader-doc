...
本次 4 月发版的导数工具 4.2.0 主要支持在 Amazon S3 进行导入导出、支持及时上传/批量上传数据到云存储空间，以及对命令行敏感信息进行加密的功能。
...
* 结构导出功能差异
  ...
  ![known issues](https://obbusiness-private.oss-cn-shanghai.aliyuncs.com/doc/img/obloaderobdumper/420/known%20issues%20ce.png)