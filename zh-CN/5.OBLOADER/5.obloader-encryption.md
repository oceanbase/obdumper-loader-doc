...
1. 安装 [OpenSSL 工具包](https://www.openssl.org/source/?spm=a2c4g.42216.0.0.7097553fHQEFiE)。
   ...
   <main id="notice" type='notice'>
     ...
     <li>secure-gen 支持读取本地文件或是交互式编辑的方式获取敏感信息并对其进行加密。</li>
     <li>secure-gen 在 <code>${ob-loader-dumper}/bin/` 目录下，可执行 <code>./secure-gen -h</code> 或直接输入 <code>./secure-gen</code> 查看使用帮助。
     <pre>
