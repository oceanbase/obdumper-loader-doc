...
* --storage-uri ' ***storage_uri_string*** '
  ...
  |  **参数** |**说明**|
  |----------------------------------|--------------------------------------------------------|
  |  scheme | 支持的存储类型：[Aliyun OSS](https://help.aliyun.com/document_detail/31817.html?spm=5176.8465980.help.dexternal.4e701450fT87ve)/[Amazon S3](https://docs.aws.amazon.com/zh_cn/s3/index.html)/Hadoop。<br> 如果指定的 scheme 不是当前支持的 OSS/S3，则会报错。|
