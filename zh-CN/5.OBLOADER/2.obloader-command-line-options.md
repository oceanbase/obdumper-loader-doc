...
* --storage-uri ' ***storage_uri_string*** '
  ...
  | principle  |是 |用于指定 Kerberos 中的身份验证标识符。|Apache Hadoop|4.2.1|
  ...
  <main id="notice" type='explain'>
    ...
    <li>从 Hadoop 导入数据库对象定义和表数据时，hdfs-site-file, core-site-file, principle, keytab-file, krb5-conf-file 为必填参数。</li>
    </ul>
  </main>
