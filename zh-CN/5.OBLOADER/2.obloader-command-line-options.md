...
* --storage-uri ' ***storage_uri_string*** '
  ...
  | host |指定云存储空间名称。<ul><li>从 OSS/S3 导入数据时，host 指代 bucket，具体请参考 [OSS Bucket](https://help.aliyun.com/document_detail/31827.html#section-yxy-jmt-tdb)。</li><li>从 Apache Hadoop 导入数据时，该项为 host。</li></ul>  |
