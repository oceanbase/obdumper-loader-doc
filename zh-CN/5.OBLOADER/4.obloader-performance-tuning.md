...
* 机器的负载和网络都较低时，视情况可调整 `--thread` 选项的参数值。
  ...
  <main id="notice" type='explain'>
    <h4>说明</h4>
    <p>调优时可关注 OBLOADER 运行的机器、ODP 服务节点以及 OceanBase 集群中的各个节点的资源使用率。其中 ODP 所在的机器需要重点关注网络。</p>
  </main>
...
| alter system set writing_throttling_trigger_percentage=100;                                                | 100        | 设定服务端内存限流阈值。<blockquote> **注意** <br> OceanBase 2.2.30 及之后版本才支持该系统参数，要求工具拥有防导爆能力。</blockquote>                                                                                                                                                                         |
